...
function Num(params) {
  return convertParams(z.number(), params).openapi({
    type: "number"
  });
}
__name(Num, "Num");
...
function Bool(params) {
  return convertParams(z.boolean(), params).openapi({
    type: "boolean"
  });
}
__name(Bool, "Bool");
...
var TaskFetch = class extends OpenAPIRoute {
  static {
    __name(this, "TaskFetch");
  }
  schema = {
    tags: ["Tasks"],
...
// .wrangler/tmp/bundle-Y7z6vg/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Y7z6vg/middleware-loader.entry.ts
